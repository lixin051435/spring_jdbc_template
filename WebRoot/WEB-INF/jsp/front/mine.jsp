		...
		<div class="row">
			...
			<div class="span8 page-content">
				...
				<form id="registerFormuser" class="row"
					...
					<div class="span6">
						<input type="text" name="mb1" value="${customer.mb1 }" id="mb1" placeholder="密保">
					</div>
					<div class="span2">
					...
					<div class="span6">
						<input type="text" name="mb2" value="${customer.mb2 }"  id="mb2" placeholder="密保">
					</div>
					<div class="span2">
					...
					<div class="span6">
						<input type="text" name="mb3" value="${customer.mb3 }"  id="mb3" placeholder="密保">
					</div>
