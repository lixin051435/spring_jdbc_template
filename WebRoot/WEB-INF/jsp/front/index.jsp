                    ...
                    <div class="span8 page-content">
                            ...
                            <div class="row separator">
                                    <section class="span8 articles-list">
                                            <h3><a href="#">精选推送</a></h3>
                                            <ul class="articles">
                                            	<c:forEach items="${tuijianList }" var="listss">
                                            		<li class="article-entry standard">
                                                            <h4>
                                                            <img src="${ctx }/${listss.pic}" style="height: 100px;">
                                                            <a href="wdxxShow.html?id=${listss.id }">${listss.title }[${listss.bkName }]</a></h4>
                                                            <span class="article-meta">(${listss.insertDate })<a href="wdxxShow.html?id=${listss.id }" >${listss.customerName }</a></span>
                                                            <span class="like-count">${listss.zans }</span>
                                                    </li>
