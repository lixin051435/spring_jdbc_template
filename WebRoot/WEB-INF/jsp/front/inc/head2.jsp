...
<body>
					...
					<div class="menu-top-menu-container">
						<ul id="menu-top-menu" class="clearfix">
			         	...
			         	<c:when test="${customerBean!=null }">
			         		...
			         		<li><a href="wdxxList.html">我的美护品测评信息</a></li>
			         		<li><a href="mine.html" >个人信息</a></li>
			         		<li><a href="#"><img src="${ctx }/${customerBean.headPic }" style="height: 30px;">${customerBean.username }</a></li>
			         		<li><a href="out.html">注销</a></li>
			         		<li><a href="${ctx }/adminLogin/login.html" target="_blank">后台登录</a></li>
			         		</c:if>
			         	</c:when>
			         	<c:otherwise>
	...
	<div class="search-area-wrapper">
                        <div class="search-area container">
                                ...
                                <form id="searchform" name="searchform" class="search-form clearfix" method="POST" action="${ctx }/front/luntan.html" autocomplete="off" novalidate="novalidate">
                                        <input class="search-term required" type="text" id="searchName" name="searchName" placeholder="美护品测评名称模糊查询" title="">
                                        <input class="search-btn" type="button" onclick="searchAA();" value="搜索美护品测评">
