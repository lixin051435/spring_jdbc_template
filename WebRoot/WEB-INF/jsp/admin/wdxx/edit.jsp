	...
	<form id="form1" name="form1" action="" method="post">
		...
		<center>
			<table class="mobile" style="width: 95%;">
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">我： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">标题： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><input type="text" id="title"
				...
				<tr height="25">
					<td class="outDetail" style="width: 30%">赞： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"><input id="zan" type="text"
						value="${map.zan }" name="zan" /></td>
				</tr>
				<tr height="25">
					<td class="outDetail" style="width: 30%">发布日期： <label
						style="font-weight: bold; color: red"> </label></td>
					<td class="outDetail2"></td>
				</tr>
				<c:if test="${1==1 }"></c:if>
