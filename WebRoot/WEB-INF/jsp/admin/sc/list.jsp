...
<html>
	<body>
		<display:table name="list"
			...
			<display:column title="分类" property="types"/>
			<display:column title="名称" property="scName"/>
			<display:column title="图片">
				<img style="width:100px;" src="${ctx}/${row.pic}"/>
			</display:column>
			<display:column title="内容" property="content1"/>
						<c:choose>
	...
	function modifyOne(id,method){
			MyWindow.OpenCenterWindow('edit.html?id='+id+'&flag=${param.flag}&method='+method,'modify',900,900);
	}
</script>
</html>
