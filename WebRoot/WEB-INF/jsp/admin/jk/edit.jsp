...
<select id="types" name="types">
								<option value="油炸" ${map.types=='油炸'?'selected':'' }>油炸</option>
								<option value="清蒸" ${map.types=='清蒸'?'selected':'' }>清蒸</option>
								<option value="腌制" ${map.types=='腌制'?'selected':'' }>腌制</option>
								<option value="翻炒" ${map.types=='翻炒'?'selected':'' }>翻炒</option>
					</select>
</td>
</tr>
<tr height="25">
